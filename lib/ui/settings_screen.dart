        ...
        children: [
          ...
          Row(
            children: [
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text('Обновлять все профили по таймеру',
                        style: theme.textTheme.muted),
                  ],
                ),
              ),
              ShadSwitch(
                ...
                onChanged: (v) =>
                    c.updateSettings(s.copyWith(autoRefreshEnabled: v)),
              ),
            ],
          ),
          if (s.autoRefreshEnabled) ...[
            ...
            ShadInput(
              ...
              placeholder: const Text('Интервал обновления (минуты)'),
              keyboardType: TextInputType.number,
              onSubmitted: (v) {
                final m = int.tryParse(v.trim());
                if (m != null && m >= 1) {
                  c.updateSettings(s.copyWith(autoRefreshIntervalMinutes: m));
                }
              },
            ),
          ],
